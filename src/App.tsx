            ...
            if (overwrite) {
                if (i >= overwriteStart && i <= overwriteEnd) {
                    ...
                    x =
                        one +
                        overwrite +
                        two.substring(overwrite.length - 1, two.length)
                }
            }
            return x
        })
            ...
            <div className='row space-x-2'>
                <div className='col space-y-1'>
                    ...
                    <input
                        ...
                        onChange={(e) => setInsertEnd(parseInt(e.target.value))}
                    />
                </div>
                <div className='col space-y-1'>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            setOverwriteEnd(parseInt(e.target.value))
                        }
                    />
                </div>
                <div className='col space-y-1'>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            setReplaceEnd(parseInt(e.target.value))
                        }
                    />
                </div>
            </div>
